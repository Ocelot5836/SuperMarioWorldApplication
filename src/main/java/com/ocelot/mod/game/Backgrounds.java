...
public class Backgrounds {
	...
	public static final Sprite[] UNDERWATER = new Sprite[] { new Sprite(ANIMATED_SHEET.getSubimage(7, 1831, 512, 432)), new Sprite(ANIMATED_SHEET.getSubimage(526, 1831, 512, 432)), new Sprite(ANIMATED_SHEET.getSubimage(7, 2281, 512, 432)), new Sprite(ANIMATED_SHEET.getSubimage(526, 2281, 512, 432)) };
	...
	public static final Sprite[] STARRY_NIGHT = { new Sprite(ANIMATED_SHEET.getSubimage(1054, 1906, 512, 432)), new Sprite(ANIMATED_SHEET.getSubimage(1572, 1906, 512, 432)), new Sprite(ANIMATED_SHEET.getSubimage(1055, 2363, 512, 432)), new Sprite(ANIMATED_SHEET.getSubimage(1572, 1906, 512, 432)) };
